...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _pageControl = [[SMPageControl alloc] initWithFrame:CGRectMake(0, frame.size.height - 40, frame.size.width, 30)];
        _pageControl.pageIndicatorImage = [UIImage imageNamed:@"pageIndicator.png"];
        _pageControl.currentPageIndicatorImage = [UIImage imageNamed:@"currentPageIndicator.png"];
...
- (void)menuButtonDidDeleteButton:(MBMenuButton *)button{
    ...
    MBAlertView *alert = [[MBAlertView alloc] initWithTitle:@"系统提示"
...
- (void)changePage:(SMPageControl *)pageControl{
