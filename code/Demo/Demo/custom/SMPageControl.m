...
- (CGImageRef)createMaskForImage:(UIImage *)image CF_RETURNS_RETAINED
{
	...
	CGContextRef context = CGBitmapContextCreate(NULL, pixelsWide, pixelsHigh, CGImageGetBitsPerComponent(image.CGImage), bitmapBytesPerRow, NULL, kCGBitmapAlphaInfoMask);
