...
_EXTERN const char* kGXMLXPathDefaultNamespacePrefix _INITIALIZE_AS("_def_ns");
...
enum {
  ...
  GXMLAttributeKind,
  GXMLNamespaceKind,
  GXMLProcessingInstructionKind,
  GXMLCommentKind,
  GXMLTextKind,
  GXMLDTDKind,
  GXMLEntityDeclarationKind,
  GXMLAttributeDeclarationKind,
  GXMLElementDeclarationKind,
  GXMLNotationDeclarationKind
};

typedef NSUInteger GXMLNodeKind;

@interface GXMLNode : NSObject <NSCopying> {
@protected
...
+ (GXMLElement *)elementWithName:(NSString *)name URI:(NSString *)value;
...
@interface GXMLElement : GXMLNode
...
- (GXMLNode *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
...
@interface GXMLDocument : NSObject {
@protected
